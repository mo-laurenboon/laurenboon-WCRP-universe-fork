...
"""
# the script need to be run from root repo dir !
...
OUTPUT_DIR = Path("./publication_status")
...
def convert() -> None:
    ...
    try:
        ...
        for term_id, details in source_data.items():
            ...
            term_data = {
                ...
                "id": term_id.lower(),
                "type": "publication_status",  # here we have to tell the type from Universe DD to get the pydantic in esgvoc
